...
0 6 * * * /<pathTo>/python3 /<pathTo>/umbrellaReminder.py > /<pathTo>/Umbrella/crontab.log 2>&1
"""
...
accountSID = '<accounSID from twilio>'
authToken = '<authToken from twilio>'
messageBody = "Don't forget to take your umbrella! Possible rain :)"
